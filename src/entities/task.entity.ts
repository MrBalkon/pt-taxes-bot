...
export class Task {
  ...
  @Column('enum', {
    name: 'task_type',
    enum: TaskType,
    default: TaskType.DATA_EXTRACTION,
  })
  type: TaskType;

  @Column('enum', {
    name: 'lifespan_type',
    enum: TaskLifespanType,
    default: TaskLifespanType.ON_DEMAND,
  })
  ...
  @Column('enum', {
    ...
    default: TaskExecutionType.NONE,
  })
  ...
  @OneToMany(
    ...
    (executionScenarionTask) => executionScenarionTask.task,
  )
