...
export class AddYearAgo1722817674117 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_fields_time_range_type_enum" AS ENUM('previous_quarter', 'previous_month', 'previous_year', 'year_ago')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_output_fields_time_range_type_enum" AS ENUM('previous_quarter', 'previous_month', 'previous_year', 'year_ago')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_output_fields_time_range_type_enum_old" AS ENUM('previous_quarter', 'previous_month', 'previous_year')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_fields_time_range_type_enum_old" AS ENUM('previous_quarter', 'previous_month', 'previous_year')`,
    );
    await queryRunner.query(
