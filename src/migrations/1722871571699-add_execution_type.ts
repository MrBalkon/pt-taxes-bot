...
export class AddExecutionType1722871571699 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_execution_type_enum" AS ENUM('none', 'invoke_manager')`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD "execution_type" "public"."tasks_execution_type_enum" NOT NULL DEFAULT 'none'`,
    );
  }
