...
export class AddPayments1723166019227 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_status_enum" AS ENUM('not_payed', 'payed')`);
        ...
        await queryRunner.query(`ALTER TABLE "payment" ADD CONSTRAINT "FK_5862bc5872d42fcf4247519b6cd" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "payment" DROP CONSTRAINT "FK_5862bc5872d42fcf4247519b6cd"`);
