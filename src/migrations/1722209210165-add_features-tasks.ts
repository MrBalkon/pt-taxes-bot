...
export class AddFeaturesTasks1722209210165 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "features-tasks" ("id" SERIAL NOT NULL, "feature_id" integer NOT NULL, "task_id" integer NOT NULL, CONSTRAINT "PK_1160f4753f9064cc340552d200b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "features-tasks" ADD CONSTRAINT "FK_cbde35bd5d407d780790605ad03" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "features-tasks" ADD CONSTRAINT "FK_0b9be2be3d9556f9de49c717a21" FOREIGN KEY ("feature_id") REFERENCES "features"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "features-tasks" DROP CONSTRAINT "FK_0b9be2be3d9556f9de49c717a21"`,
    );
    await queryRunner.query(
      `ALTER TABLE "features-tasks" DROP CONSTRAINT "FK_cbde35bd5d407d780790605ad03"`,
    );
