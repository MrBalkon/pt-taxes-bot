...
export class TaxScene {
    ...
    ctx.reply(this.i18n.t('t.tax.welcome'), {
      reply_markup: {
        inline_keyboard: [
          [
            {
              text: this.i18n.t('t.tax.socialSecurity'),
              callback_data: 'taxScene.socialSecurityAction',
            },
          ],
          [
            {
              text: this.i18n.t('t.tax.iva'),
              callback_data: 'taxScene.ivaAction',
            },
          ],
          [
            {
              text: this.i18n.t('t.tax.irs'),
              callback_data: 'taxScene.irsAction',
            },
          ],
          [
            {
              text: this.i18n.t('t.tax.financaisFillData'),
              callback_data: 'taxScene.financaisFillData',
            },
          ],
        ],
      },
  ...
  async onAnswerfinancaisFillDatay(@Ctx() ctx: SceneContext) {
  ...
  async onAnswerSocialSecurity(@Ctx() ctx: SceneContext) {
    await this.taskProcessingQueueService.addJobByTelegramId<null>(
      ctx.from.id,
      {
