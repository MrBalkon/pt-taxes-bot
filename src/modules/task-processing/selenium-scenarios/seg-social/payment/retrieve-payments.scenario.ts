...
export const PAYMENT_LINK = 'https://app.seg-social.pt/ptss/ci/documento-pagamento/pesquisar-doc-pagamento'
...
export const retrievePayments = async (driver: WebDriver): Promise<SegSocialPaymentData[]> => {
	// find table with id = "form:DPDataTable_data"
	const table = await driver.wait(until.elementLocated({ id: 'form:DPDataTable_data' }), 10000)
